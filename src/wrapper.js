...
export const Wrapper = ({location, innerWidth, navBar, footerAddLinks, footerSocialLinks}) => {
    return (
        <>
            <Header nav={navBar} />
            <Routes>
            ...
            {navBar && <Footer {...navBar} footerAddLinks={footerAddLinks} footerSocialLinks={footerSocialLinks} />}
        </>
    )
}