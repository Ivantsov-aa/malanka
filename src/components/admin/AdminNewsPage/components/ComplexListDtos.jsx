...
import {AddDeleteBtnsContainerStyled, AddListElementButtonStyled, AdminNewsPageTextareaStyled, ContentEditControlContainerStyled, ContentEditControlStyled, DeleteListElementButtonStyled} from "../AdminNewsPage.style"

export const ComplexListDtos = ({item, i, templateRows, setTemplateRows, handleReplaceRows, handleDelete}) => {
    return (
                            ...
                            <AddDeleteBtnsContainerStyled>
                                <AddListElementButtonStyled
                                    ...
                                    onClick={() => {
                                        ...
                                        const tempArray = templateRows.map((row, d) => (
                                            i === d ?
                                                {
                                                    ...row,
                                                    complexListPartDtos: temp
                                                }
                                                :
                                                {...row}
                                        ))
                                ...
                                >
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M12 22C17.5229 22 22 17.5229 22 12C22 6.47715 17.5229 2 12 2C6.47715 2 2 6.47715 2 12C2 17.5229 6.47715 22 12 22Z" stroke="#6FBE6E" strokeWidth="2" strokeLinejoin="round" />
                                        <path d="M12 8V16" stroke="#6FBE6E" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                                        <path d="M8 12H16" stroke="#6FBE6E" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                                    </svg>
                                </AddListElementButtonStyled>
                                    ...
                                    onClick={() => {
                                        const tempArray = templateRows.map((row, d) => (
                                            i === d ?
                                                {
                                                    ...row,
                                                    complexListPartDtos: row.complexListPartDtos.filter((el, z) => z !== j)
                                                }
                                                :
                                                {...row}
                                        ))
                                ...
                                >
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M4.5 5V22H19.5V5H4.5Z" stroke="#FC978C" strokeWidth="3" strokeLinejoin="round" />
                                        <path d="M10 10V16.5" stroke="#FC978C" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
                                        <path d="M14 10V16.5" stroke="#FC978C" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
                                        <path d="M2 5H22" stroke="#FC978C" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
                                        <path d="M8 5L9.6445 2H14.3885L16 5H8Z" stroke="#FC978C" strokeWidth="3" strokeLinejoin="round" />
                                    </svg>
                                </DeleteListElementButtonStyled>
                            </AddDeleteBtnsContainerStyled>
                            <AdminNewsPageTextareaStyled
                                ...
                                onInput={autosizeTextarea}
                                onChange={(e) => {
                                    const tempArray = templateRows.map((sub, b) => (
                                        i === b ?
                                            {
                                                ...sub,
                                                complexListPartDtos: sub.complexListPartDtos.map((el, z) => (
                                                    z === j ? {...el, title: e.target.value} : {...el}
                                                ))
                                            }
                                            :
                                            {...sub}
                                ...
                                <li key={k}>
                                    <AddDeleteBtnsContainerStyled>
                                        <AddListElementButtonStyled
                                            type='button'
                                            onClick={() => {
                                                const temp = subtitle.complexRows;
                                                temp.splice(k + 1, 0, row);
                                                const tempArray = templateRows.map((elem, d) => (
                                                    i === d ?
                                                        {
                                                            ...elem,
                                                            complexListPartDtos: elem.complexListPartDtos.map((el, e) => (
                                                                e === k ?
                                                                    {...el, complexRows: temp}
                                                                    :
                                                                    {...el}
                                                    ...
                                                    i === d ?
                                                        {
                                                            ...
                                                            complexListPartDtos: elem.complexListPartDtos.map((el, e) => (
                                                                e === j ?
                                                                    {...el, complexRows: el.complexRows.filter((m, f) => k !== f)}
                                                                    :
                                                                    {...el}
                                                            ))
                                                        }
                                                ...
                                                i === b ?
                                                    {
                                                        ...
                                                        complexListPartDtos: sub.complexListPartDtos.map((el, z) => (
                                                            z === j ?
                                                                {
                                                                    ...el, complexRows: el.complexRows.map((val, c) => (
                                                                        c === k ?
                                                                            e.target.value
                                                                            :
                                                                            val
