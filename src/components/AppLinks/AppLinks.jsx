export const AppLinks = ({ outline, horizontal }) => {
    return (
        <div className={`app-links ${outline ? outline : ''} ${horizontal ? horizontal : ''}`}>
            ...
            <a href='https://play.google.com/store/apps/details?id=by.malankabn.app' target='_blank'>
